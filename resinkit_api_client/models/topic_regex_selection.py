...
T = TypeVar("T", bound="TopicRegexSelection")


@_attrs_define
class TopicRegexSelection:
    """Configuration for selecting topics using regex

    Attributes:
        name_regex (str): Regular expression to match topic names
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        topic_regex_selection.additional_properties = d
        return topic_regex_selection
