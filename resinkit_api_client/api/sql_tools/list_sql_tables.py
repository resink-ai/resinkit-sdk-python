...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/v1/agent/sql/sources/{source_name}/tables",
        "params": params,
    }
...
) -> Optional[Union[HTTPValidationError, list["TableInfo"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[HTTPValidationError, list["TableInfo"]]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[HTTPValidationError, list['TableInfo']]
    """
