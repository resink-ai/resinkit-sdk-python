...
class VariablesUI:
    def __init__(self, base_url: str, session_id: Optional[str] = None, personal_access_token: Optional[str] = None):
        ...
        self.description_input = pn.widgets.TextAreaInput(name='Description', placeholder='Enter description', max_length=500, rows=3)
    ...
    def _load_variables(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            for var in variables:
                var['actions'] = f'<button class="btn btn-danger btn-sm delete-btn" data-var-name="{var["name"]}">Delete</button>'
