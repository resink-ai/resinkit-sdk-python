...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        catalog_name (str): The name of the catalog to update
        body (CatalogRequest):  Example: {'name': 'my_catalog', 'properties': {'default-database':
            'mydb', 'username': 'user', 'password': 'password', 'base-url':
